...
struct ResolvedRenderConfig {
    ...
    var cameraProfileName: String = "ideal"
    var cameraProfileID: UInt32 = 0
    var realismProfileName: String = "off"
    var realismProfileID: UInt32 = 0
    var cameraProfileJSONPath: String = ""
    var cameraSceneR: SIMD4<Float> = SIMD4<Float>(1, 0, 0, 0)
    var cameraSceneG: SIMD4<Float> = SIMD4<Float>(0, 1, 0, 0)
    var cameraSceneB: SIMD4<Float> = SIMD4<Float>(0, 0, 1, 0)
    var cameraDisplayR: SIMD4<Float> = SIMD4<Float>(1, 0, 0, 0)
    var cameraDisplayG: SIMD4<Float> = SIMD4<Float>(0, 1, 0, 0)
    var cameraDisplayB: SIMD4<Float> = SIMD4<Float>(0, 0, 1, 0)
