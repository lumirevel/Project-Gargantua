...
//  Blackhole
//
//  Auto-generated from historical main.swift during Phase 1 modularization.
//
...
enum AppMain {
    static func run(arguments: [String]) throws {
        ...
        _ = ParamsBuilder.build(from: CLI.parse(arguments: arguments))
        if RegressionRunner.shouldRun(in: cliArguments) {
            try RegressionRunner.run(arguments: cliArguments)
            return
        }
        if cliArguments.contains("--print-packed-layout") {
