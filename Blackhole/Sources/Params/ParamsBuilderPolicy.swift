...
enum ParamsBuilderPolicy {
    ...
    static func resolveGRMHDPolicy(
        ...
        case "gamma", "lorentz", "lorentz-factor":
            diskGrmhdDebugID = 14
        case "tau", "optical-depth", "optical_depth", "physics-optical-depth", "physics_optical_depth":
            diskGrmhdDebugID = 15
        ...
        case "tau1-depth", "tau-one-depth", "tau1-path", "photosphere-depth":
            diskGrmhdDebugID = 25
        case "tau-wide", "optical-depth-wide", "optical_depth_wide", "physics-optical-depth-wide", "physics_optical_depth_wide":
            diskGrmhdDebugID = 26
        ...
        case "transfer-saturation", "transfer_saturation", "tau-saturation", "tau_saturation", "saturation-from-tau":
            diskGrmhdDebugID = 56
        case "body-ratio", "body_fraction", "body-fraction", "thermal-body-ratio", "photosphere-fraction":
            diskGrmhdDebugID = 57
        case "skin-body-balance", "cloud-body-balance", "skin-to-body", "cloud-to-body":
            diskGrmhdDebugID = 58
    ...
    static func resolveDiskModel(
        ...
        case "legacy-feb24", "legacy-raw", "legacy-raw-perlin", "raw-perlin", "feb24", "legacy-582", "legacy-ea08066":
            diskModelResolved = "legacy-feb24"
        case "perlin-classic", "perlin-f552", "legacy-f552", "flow-f552", "cloud-f552", "procedural-f552", "f552":
            diskModelResolved = "legacy-f552"
        case "legacy-periodic-thin", "periodic-thin", "legacy-936", "legacy-cinema-thin":
            diskModelResolved = "legacy-periodic-thin"
        ...
        default:
            fail("invalid --disk-model \(diskModelArg). use one of: flow, perlin, perlin-ec7, legacy-feb24, legacy-f552, legacy-periodic-thin, legacy-grmhd-atlas, atlas, auto (aliases include procedural, legacy-raw, perlin-classic, perlin-f552, legacy-936)")
        }
        ...
        let diskNoiseModel: UInt32 = {
            ...
            case "legacy-periodic-thin": return 4
            case "legacy-feb24": return 5
            default: return 0
            }
        }()
