...
enum ParamsBuilder {
    ...
    let diskOrbitalBoostArg = max(0.0, doubleArg("--disk-orbital-boost", default: 1.0))
    ...
    let diskOrbitalBoostInnerArg = max(0.0, doubleArg("--disk-orbital-boost-inner", default: diskOrbitalBoostArg))
    let diskOrbitalBoostOuterArg = max(0.0, doubleArg("--disk-orbital-boost-outer", default: diskOrbitalBoostArg))
